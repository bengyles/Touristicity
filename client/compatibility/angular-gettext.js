    ...
    return {
        ...
        compile: function compile(element, attrs) {
            ...
            if (msie <= 8) {
                ...
                // anchors. angular/angular.compatibility/#1949 / angular/angular.compatibility/#2013
...
angular.module('gettext').factory('gettextUtil', function gettextUtil() {
     ...
     * @description Trim polyfill for old browsers (instead of jQuery). Based on AngularJS-v1.2.2 (angular.compatibility#620).
     *
     * Example
     * ```compatibility
